...
def train(run_name, experiment_name, fold_i=0, base_dir = None,removeValES = False,removeValMyoES = True,loss="leaf_dice_loss", metric="leaf_dice_metric"):
    nb_classes = 4
...
if __name__ == '__main__':
    for f in range(0,5):
        train('Trained_models', 'partial_leaf_DSC', fold_i=f,
              base_dir=main_dir, loss="leaf_dice_loss", metric="leaf_dice_metric")
