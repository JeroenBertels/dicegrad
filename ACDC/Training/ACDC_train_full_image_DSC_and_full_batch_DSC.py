...
def train(run_name, experiment_name, fold_i=0, base_dir = None,reduce_along_batch = False,reduce_along_features=False):
    nb_classes = 4
...
if __name__ == '__main__':
    for f in range(0, 5):
        train('Trained_models', 'full_image_DSC', fold_i=f,
              base_dir=main_dir, reduce_along_batch=False)
        tf.keras.backend.clear_session()

    for f in range(0, 5):
        train('Trained_models', 'full_batch_DSC', fold_i=f,
